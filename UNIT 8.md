...
| The First Floor | The Second Floor                                         | The Second Floor   |
| --------------- | -------------------------------------------------------- | ------------------ |
| A house         | An Apartment Building                                    | An Office Building |
| a garden        | a stairway   `/ˈsterweɪ/  n.<br/>楼梯，阶梯  `           | an elevator        |
| a garage        | an apartment                                             | an office          |
|                 | a balcony    `/ˈbælkəni/ n.<br/>露台，阳台；楼座，楼厅 ` |                    |
| a bus station   | a train station                                          | a stadium          |
| a park          | a mall                                                   | a museum           |
| an airport      | a hospital                                               |                    |

### Grammar

![疑问句语法](D:\code-life\myEnglishLab\疑问句语法.png)

#### Questions with <u>Where</u>

| Where do you live?        | Where does he work?          |
| ------------------------- | ---------------------------- |
| Where do you parent live? | Where does your mother work? |

#### Prepositions of place

![in_on_at](D:\code-life\myEnglishLab\in_on_at.png)

| in  【空间范围内】            | at 【店铺、号+街道】                | on 【街道、层数】                  |
| ----------------------------- | ----------------------------------- | ---------------------------------- |
| She lives **in** an apartment | I live **at** 50 Main Street        | Her house is **on** Bank Street    |
| They live **in** a house      | He works **at** a bookstore         | We go to school **on** 34th Avenue |
| I work **in** an office       | They study **at** the Brooke School | I work **on** the tenth floor      |
...
B: No, About fifteen minutes bu bus.
